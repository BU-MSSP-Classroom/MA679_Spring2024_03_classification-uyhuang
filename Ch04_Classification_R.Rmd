...
# Plotting each continuous variable against mpg01
par(mfrow = c(2, 2)) # Setting up the plotting area to have 2 rows and 2 columns
for (var in con_vars) {
...
# Plotting boxplots for each categorical variable
par(mfrow = c(2, 2)) # Adjust the plotting area based on the number of categorical variables
for (var in cat_vars) {
  boxplot(auto$mpg01 ~ auto[[var]], main = paste("mpg01 vs", var), xlab = var, ylab = "mpg01")
}
